...
var nextSong = function(e){
    ...
    var nxt = $(e.currentTarget).hasClass("next") ? idx+1 : idx-1;
    if( nxt >= currentAlbum.songs.length ) nxt = 0;
    if( nxt < 0 ) nxt = currentAlbum.songs.length-1;
    $(".song-item-number[data-song-number = '" + ++nxt + "']").click();
};
